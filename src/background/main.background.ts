...
import { PasswordRulesParserService } from 'jslib-common/services/passwordRulesParser.service';
...
import { PasswordRulesParserService as PasswordRulesParserServiceAbstraction } from 'jslib-common/abstractions/passwordRulesParser.service';
...
export default class MainBackground {
    ...
    constructor() {
        ...
        this.runtimeBackground = new RuntimeBackground(this, this.autofillService, this.cipherService,
            ...
            this.environmentService, this.policyService, this.userService, this.passwordGenerationService, this.messagingService, this.folderService, this.passwordRulesParserService);
